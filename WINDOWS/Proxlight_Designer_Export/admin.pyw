...
class Student:
	def __init__(self,ventana):
		...
		self.ventana.configure(bg = "#323234")
		self.ventana.overrideredirect(True)

		title=Label(self.ventana,text="Sistema Administrador de Estudiantes", bd=10,relief=RAISED, font=("Courier", 25,"bold"),bg="#557B83", fg="white")
		title.pack(side=TOP)

		Exit_btn=Button(ventana,text="Salir", width=7, bg="orange", font=("Arial",17,"bold"),command=mensaje)
		Exit_btn.place(x=1237, y=10)
		...
		Manage_Frame=Frame(self.ventana,bd=4,relief=RIDGE, bg="#557B83")
		Manage_Frame.place(x=20,y=75,width=520,height=620)

		m_title=Label(Manage_Frame,text="Control de Estudiantes", bg="#557B83", fg="white", font=("Arial",23,"bold"))
		m_title.grid(row=0,columnspan=2,pady=20)

		lbl_roll=Label(Manage_Frame,text="Matricula:", bg="#557B83", fg="white", font=("Trebuchet MS",20,"bold"))
		lbl_roll.grid(row=1,column=0,pady=10,padx=20,sticky="w")

		txt_Roll=Entry(Manage_Frame, textvariable=self.matricula_var , font=("Trebuchet MS",15,"bold"), bd=5, relief=GROOVE)
		txt_Roll.grid(row=1,column=1,pady=10,padx=20,sticky="w")

		lbl_name=Label(Manage_Frame,text="Nombre:", bg="#557B83", fg="white", font=("Trebuchet MS",20,"bold"))
		lbl_name.grid(row=2,column=0,pady=10,padx=20,sticky="w")

		txt_name=Entry(Manage_Frame, textvariable=self.nombre_var, font=("Trebuchet MS",15,"bold"), bd=5, relief=GROOVE)
		txt_name.grid(row=2,column=1,pady=10,padx=20,sticky="w")

		lbl_email=Label(Manage_Frame,text="Correo E.", bg="#557B83", fg="white", font=("Trebuchet MS",20,"bold"))
		lbl_email.grid(row=3,column=0,pady=10,padx=20,sticky="w")

		txt_email=Entry(Manage_Frame, textvariable=self.email_var, font=("Trebuchet MS",15,"bold"), bd=5, relief=GROOVE)
		txt_email.grid(row=3,column=1,pady=10,padx=20,sticky="w")

		lbl_gender=Label(Manage_Frame,text="Genero", bg="#557B83", fg="white", font=("Trebuchet MS",20,"bold"))
		lbl_gender.grid(row=4,column=0,pady=10,padx=20,sticky="w")

		combo_genero=ttk.Combobox(Manage_Frame,textvariable=self.genero_var , width=9, font=("Trebuchet MS",15,"bold"),state='readonly')
		combo_genero['values']=("Masculino","Femenino","Otro")
		combo_genero.grid(row=4, column=1,padx=20,pady=10)

		lbl_telefono=Label(Manage_Frame,text="Telefono:", bg="#557B83", fg="white", font=("Trebuchet MS",20,"bold"))
		lbl_telefono.grid(row=5,column=0,pady=10,padx=20,sticky="w")

		txt_telefono=Entry(Manage_Frame,textvariable=self.telefono_var, font=("Trebuchet MS",15,"bold"), bd=5, relief=GROOVE)
		txt_telefono.grid(row=5,column=1,pady=10,padx=20,sticky="w")

		lbl_fdn=Label(Manage_Frame,text="F.D.N.", bg="#557B83", fg="white", font=("Trebuchet MS",20,"bold"))
		lbl_fdn.grid(row=6,column=0,pady=10,padx=20,sticky="w")

		txt_fdn=Entry(Manage_Frame,textvariable=self.fdn_var, font=("Trebuchet MS",15,"bold"), bd=5, relief=GROOVE)
		txt_fdn.grid(row=6,column=1,pady=10,padx=20,sticky="w")

		lbl_direccion=Label(Manage_Frame,text="Domicilio:", bg="#557B83", fg="white", font=("Trebuchet MS",20,"bold"))
		lbl_direccion.grid(row=7,column=0,pady=10,padx=20,sticky="w")

		self.txt_direccion=Text(Manage_Frame,width=30,height=4, font=("Trebuchet MS",10,"bold"))
		self.txt_direccion.grid(row=7,column=1,pady=10,padx=20,sticky="w")

		btn_Frame=Frame(Manage_Frame,bd=4,relief=RIDGE, bg="#323234")
		btn_Frame.place(x=15,y=550,width=420)

		Add_btn=Button(btn_Frame,text="Agregar", width=10, command=self.agregar_estudiantes)
		Add_btn.grid(row=0, column=0, padx=10, pady=10)

		Update_btn=Button(btn_Frame, command=self.update_data, text="Actualizar", width=10)
		Update_btn.grid(row=0, column=1, padx=10, pady=10)

		Delete_btn=Button(btn_Frame,text="Eliminar", width=10, command=self.delete_data)
		Delete_btn.grid(row=0, column=2, padx=10, pady=10)

		Clear_btn=Button(btn_Frame,text="Limpiar", width=10, command=self.clear)
		Clear_btn.grid(row=0, column=3, padx=10, pady=10)

		Detail_Frame=Frame(self.ventana,bd=4,relief=RIDGE, bg="#39AEA9")
		Detail_Frame.place(x=550,y=75,width=810,height=620)

		lbl_search=Label(Detail_Frame,text="Buscar por:", bg="#323234", fg="white", font=("Arial",20,"bold"))
		...
		search_btn=Button(Detail_Frame,text="Buscar", width=10,command=self.buscar_data)
		search_btn.grid(row=0, column=4, padx=10, pady=10)

		showall_btn=Button(Detail_Frame, text="Mostrar Todo", font=("Arial", 9) ,width=12,command=self.fetch_data)
		showall_btn.grid(row=0, column=5, padx=10, pady=10)

		Table_Frame=Frame(Detail_Frame,bd=4,relief=RIDGE, bg="crimson")
		Table_Frame.place(x=10,y=70,width=780,height=530)
	...
	def agregar_estudiantes(self):
		...
		if self.matricula_var.get()=="" or self.nombre_var.get()=="" or self.email_var.get()=="" or self.genero_var.get()=="" or self.telefono_var.get()=="" or self.fdn_var.get()=="":
			...
			con=pymysql.connect(host="localhost", user="root",password="",database="studentm")
			cur=con.cursor()
